...
stft = TacotronSTFT(hparams.filter_length, hparams.hop_length, hparams.win_length,
                    ...
                    hparams.mel_fmax)
speaker = "Main"
checkpoint_path = '/mnt/sdc1/pitchtron/vlre_1D_200228/checkpoint_194000'
...
audio_paths = 'filelists/object_test_samles.txt'
...
speaker_ids = TextMelLoader("/home/admin/projects/pitchtron_init_with_single/filelists/merge_korean_pron_train.txt", hparams).speaker_ids
...
for i, batch in enumerate(dataloader):
    ...
    with torch.no_grad():
        ...
        for j in range(len(audio)):
            ...
            write("/mnt/sdc1/pitchtron_experiment/different_speaker_objective_test/no_scale/vlre_1D/sample-{:03d}_target_speaker-{}_referende_speaker-{}-vlre_1D.wav".format(i*hparams.batch_size+j, speaker, reference_speaker), hparams.sampling_rate, wav)
